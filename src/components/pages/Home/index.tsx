        ...
        <div className='flex flex-col'>
            ...
            <DragDrop onSelectedFiles={handleUploadFile} />
            {
                state.files.length > 0 && (
                    <button 
                        onClick={handleClick}
                        className="flex bg-white text-blue-600 px-4 py-2 border-2 border-blue-600 rounded-lg font-medium hover:bg-gray-50 transition-colors duration-200 items-center justify-center space-x-2"
                    >
